...
var o10665 = temp__5733__auto__;
var temp__5733__auto____$1 = (o10665["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o10666 = temp__5733__auto____$1;
return (o10666["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9699__auto__ = f;
return (o__9699__auto__["toString"]).call(o__9699__auto__);
} else {
return "";
}
}catch (e10667){var _ = e10667;
return "";
}});
...
try{var o__9699__auto___10669 = t;
(o__9699__auto___10669["cljs$lang$ctorPrWriter"]).call(o__9699__auto___10669,t,writer);
}catch (e10668){var __10670 = e10668;
}
...
var char_code = (function (){var o__9699__auto__ = (new String(char$));
return (o__9699__auto__["charCodeAt"]).call(o__9699__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9699__auto__ = String;
return (o__9699__auto__["fromCharCode"]).call(o__9699__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10671 = num_code;
switch (G__10671) {
case (1):
return (185);
...
var o__9699__auto__ = String;
return (o__9699__auto__["fromCharCode"]).call(o__9699__auto__,superscript_code);
});
/**
...
}catch (e10673){var _e__9706__auto__ = e10673;
return false;
}})())){
...
var vec__10674 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10674,(0),null);
...
var or__3949__auto__ = (function (){var temp__5733__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5733__auto__)){
...
if(cljs.core.truth_(temp__5733__auto__)){
var o10677 = temp__5733__auto__;
var temp__5733__auto____$1 = (o10677["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o10678 = temp__5733__auto____$1;
return (o10678["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10681){
var vec__10682 = p__10681;
var ns_detector = cljs.core.nth.call(null,vec__10682,(0),null);
...
var G__10688 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10689 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10688;
remaining_tokens = G__10689;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10679){
...
var vec__10693 = cljs.core.split_with.call(null,(function (p1__10692_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10692_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10693,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10693,(1),null);
...
var vec__10696 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10696,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10696,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10699 = cljs.core.rest.call(null,remaining_tokens);
var G__10700 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10699;
name_tokens = G__10700;
continue;
} else {
...
var vec__10703 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10703,(0),null);
var arity = cljs.core.nth.call(null,vec__10703,(1),null);
var vec__10706 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10706,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10706,(1),null);
var vec__10709 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10709,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10709,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10709,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10709,(3),null);
...
var vec__10715 = result;
var munged_ns = cljs.core.nth.call(null,vec__10715,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10715,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10715,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10715,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10715,(4),null);
var arity = cljs.core.nth.call(null,vec__10715,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__10719 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__10719,(0),null);
var args = cljs.core.nth.call(null,vec__10719,(1),null);
var vec__10722 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10722,(0),null);
var name = cljs.core.nth.call(null,vec__10722,(1),null);
...
var G__10725 = (arity + (1));
var G__10726 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10727){
var vec__10728 = p__10727;
var arity = cljs.core.nth.call(null,vec__10728,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10728,(1),null);
...
return (function (p1__10731_SHARP_){
return cljs.core.get.call(null,arities,p1__10731_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__10732_SHARP_){
return cljs.core.drop.call(null,(2),p1__10732_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___10739 = arguments.length;
var i__4532__auto___10740 = (0);
while(true){
if((i__4532__auto___10740 < len__4531__auto___10739)){
args__4534__auto__.push((arguments[i__4532__auto___10740]));

var G__10741 = (i__4532__auto___10740 + (1));
i__4532__auto___10740 = G__10741;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10735){
var vec__10736 = p__10735;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10736,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10733){
var G__10734 = cljs.core.first.call(null,seq10733);
var seq10733__$1 = cljs.core.next.call(null,seq10733);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10734,seq10733__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10744__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10744__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10744__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10744__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10745 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10745,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10745,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10745,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10745,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10745,(4),null);
var arity = cljs.core.nth.call(null,vec__10745,(5),null);
...
var o__9699__auto__ = f;
return (o__9699__auto__["getBasis"]).call(o__9699__auto__);
});
/**
...
}catch (e10749){var _e__9706__auto__ = e10749;
...
var G__10750 = (obj[cljs.core.first.call(null,path)]);
var G__10751 = cljs.core.rest.call(null,path);
obj = G__10750;
path = G__10751;
continue;
} else {
...
return (function (accum,p__10752){
var vec__10753 = p__10752;
var bit = cljs.core.nth.call(null,vec__10753,(0),null);
var protocol = cljs.core.nth.call(null,vec__10753,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10756){
var vec__10757 = p__10756;
var ns = cljs.core.nth.call(null,vec__10757,(0),null);
var name = cljs.core.nth.call(null,vec__10757,(1),null);
var selector = cljs.core.nth.call(null,vec__10757,(2),null);
...
return (function (p__10761){
var vec__10762 = p__10761;
var munged_name = cljs.core.nth.call(null,vec__10762,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10762,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10762,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10760_SHARP_){
return (obj[cljs.core.first.call(null,p1__10760_SHARP_)]);
});})(name,sorted_matches,vec__10762,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
