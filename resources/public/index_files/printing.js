...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10913){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10914,G__10915,seq10913__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10919_SHARP_){
return !((cljs.core.meta.call(null,p1__10919_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__10920__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10924){var _e__9706__auto__ = e10924;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e10926){var _e__9706__auto__ = e10926;
return false;
}}
})())){
...
var _STAR_current_state_STAR_10928 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__10929 = opts;
var map__10929__$1 = ((((!((map__10929 == null)))?(((((map__10929.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10929.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10929):map__10929);
var markup_db = cljs.core.get.call(null,map__10929__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_10928;
}});
...
;
var temp__5733__auto___10933 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___10933)){
var managed_print_level_10934 = temp__5733__auto___10933;
var _STAR_print_level_STAR_10932_10935 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_10934;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_10932_10935,managed_print_level_10934,temp__5733__auto___10933,writer,opts,job_fn){
return (function (p1__10931_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10931_SHARP_,null);
});})(_STAR_print_level_STAR_10932_10935,managed_print_level_10934,temp__5733__auto___10933,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_10932_10935;
}} else {
job_fn.call(null);
}
