...
var G__10869 = devtools.prefs.pref.call(null,v);
v = G__10869;
continue;
} else {
return v;
...
}catch (e10872){var _e__9706__auto__ = e10872;
return false;
}})();
...
}catch (e10876){var _e__9706__auto__ = e10876;
return false;
}})();
...
}catch (e10878){var _e__9706__auto__ = e10878;
return false;
}}
}
});
...
var vec__10880 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10880,(0),null);
var name = cljs.core.nth.call(null,vec__10880,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10883_SHARP_);
}),template);
});
